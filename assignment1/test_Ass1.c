...
int main (int argc, char *argv[]) {
	...
	*/
	printTfIdfList("tests/mars_TfIdfList.txt" , list);
	...
	*/
	printTfIdfList("tests/sun_TfIdfList.txt" , list_sun);


	TfIdfList list_moon = calculateTfIdf(invertedTree, "moon" , 7); 
	printTfIdfList("tests/moon_TfIdfList.txt" , list_moon );
	...
	*/
	printTfIdfList("tests/nasa_mars_moon.txt" , listM);
